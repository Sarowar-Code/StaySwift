"use client";
// cause this is client comp, and its client action. jodi server action hoto amra auth teke import korete partam.
...
const SocialLogins = ({ mode }) => {
    const handleAuth = (event) => {
        signIn("google", { callbackUrl: "http://localhost:5000/bookings" });
    };
